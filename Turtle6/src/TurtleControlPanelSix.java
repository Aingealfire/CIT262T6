...
public class TurtleControlPanelSix extends Panel {
  ...
  ||  void         setTextDistance()              protected
    ...
    protected Button getTurnRightButton() {
        return turnRightButton;
    }

    protected Button getTurnLeftButton() {
        return turnLeftButton;
    }

    // Checkbox(s).
    protected Checkbox getPenCheckbox() {
        return penCheckbox;
    }

    // Panel(s).
    protected Panel getToolPanel() {
        return toolPanel;
    }

    // TextArea(s).
    protected TextArea getLinesDrawn() {
        return linesDrawn;
    }

    // TextField(s).
    protected TextField getTextDistance() {
        return textDistance;
    }

    protected TextField getBeginPointTextField() {
        return beginPointTextField;
    }

    protected TextField getEndPointTextField() {
